  ...
  return (
    <header className={`${poppins.className} fixed top-5 left-1/2 transform -translate-x-1/2 w-[1840px] h-[217px] ${isHomePage ? "bg-white/5" : "bg-white/20"} backdrop-blur-lg z-50 px-4 lg:px-8 py-4 rounded-[25px] border border-[#00000080]`}> 
      <div className="flex justify-between items-center">
        ...
        <div className={`hidden lg:flex mt-5 relative items-center bg-transparent rounded-full overflow-hidden shadow-md ${isHomePage ? "border-transparent" : "border border-black"}`} style={{ width: "40%", height: "50px" }}>
          <input
            type="text"
          ...
          />
          <button className="flex items-center justify-center bg-black text-[#FFFFFF] px-6 py-3 rounded-r-full" style={{ height: "100%" }}>
        ...
        <div className="flex items-center space-x-4 mt-5 lg:space-x-8 text-white">
          <img src="/images/Heart.png" alt="Heart Icon" className="w-6 h-6 lg:w-8 lg:h-8 cursor-pointer" />
          <img src="/images/Shopping Cart.png" alt="Shopping Cart Icon" className="w-6 h-6 lg:w-8 lg:h-8 cursor-pointer" />
          <Link href="/register">
            <img src="/images/Male User.png" alt="User Icon" className="hidden lg:block w-6 h-6 lg:w-8 lg:h-8 cursor-pointer" />
          </Link>
          <button onClick={toggleMenu} className="text-lg lg:hidden cursor-pointer bg-transparent border-none">
      ...
      <div className="hidden lg:flex justify-between mt-4 items-center text-sm">
        <button onClick={toggleMenu} className="flex items-center space-x-2 px-6 py-3 rounded-full text-[#000000]">
          <img src="/images/Menu.png" alt="Menu Icon" className="w-6 h-6" />
          <span>All Categories</span>
        </button>
        <div className="flex items-center space-x-2 text-[#000000]">
          <img src="/images/Online Support.png" alt="Online Support Icon" className="w-6 h-6 lg:w-8 lg:h-8" />
          <div>

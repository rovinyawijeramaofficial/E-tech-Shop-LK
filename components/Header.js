...
<button
  ...
  <Link href="/register">
    ...
    >
      ...
      {/* Horizontal line & Below Section - Responsive Adjustments */}
      <div
        className={`hidden lg:flex fixed inset-x-0 top-[131px] z-50 items-center justify-between px-6 lg:px-10 h-[84px] border-t w-full ${ // Added w-full
